...
@DataProvider(name="Ediddata")
public String[][] editdata() throws IOException {
//	String[][] edit=new String[2][2];
//	edit[0][0]="99";
//	edit[0][1]="IBM";
//	
//	edit[1][0]="98";
//	edit[1][1]="Mindtree";
	...
	@Test(dataProvider="Ediddata")
	public  void editLead(String num,String cmpny) throws InterruptedException {
